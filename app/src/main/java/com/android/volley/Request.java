...
public abstract class Request<T> implements Comparable<Request<T>> {
     ...
     * OkHttp Body创建类型
     */
    public int getBodyCreateType() throws AuthFailureError {
    ...
    private byte[] encodeParameters(Map<String, Object> params,
        ...
        try {
            for (Map.Entry<String, Object> entry : params.entrySet()) {
                ...
                encodedParams.append(URLEncoder.encode(String.valueOf(entry.getValue()),
                        paramsEncoding));
                encodedParams.append('&');
            }
     ...
     */
    public byte[] handleRawResponse(okhttp3.Response httpResponse)
            throws IOException, ServerError, CanceledError {
        return null;
    }
